"""Configuration management for Unified Crawler.

Loads unified crawler configuration (file-based, no LMDB).
"""
...
class UnifiedCrawlerConfig:
    ...
    @classmethod
    def from_yaml(cls, config_path: str) -> 'UnifiedCrawlerConfig':
